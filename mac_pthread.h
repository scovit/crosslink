// Boring workarounds found on stackexchange and stackoverflow:
...
# define PTHREAD_PROCESS_SHARED     (43)
  ...
  static inline int pthread_barrierattr_getpshared(const pthread_barrierattr_t *restrict attr,
						   int *restrict pshared) {
    *pshared = PTHREAD_PROCESS_PRIVATE;
    return 0;
  }

  static inline int pthread_barrierattr_setpshared(pthread_barrierattr_t *attr,
						   int pshared) {
  ...
  static inline int pthread_barrier_init(pthread_barrier_t *restrict barrier,
