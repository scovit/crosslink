...
$f$ arms each of length $N$ as:
\begin{equation}
Z = \mu^{-fN} N^{\gamma_f - 1}.
\end{equation}

Due to the effect of this scaling, the collapse energy of the polymer
with bridging interactions is shifted to higher values by an entropic
contribution as\cite{Hanke2003}:
\begin{equation}
\Delta S_{star} = \sigma_{2f} \log \frac{N}{f-1},\ 
\mathrm{with}\ \sigma_{2f} = \gamma_f - \frac{\gamma_1 + 1}{2}.
\end{equation}
